        ...
        const fetchData = async () => {
            try {
                ...
                const response = await api.get(
                    "/api/supplier-categories/" + categoryId,
                    {
                        headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await api.post(
                `/api/supplier-categories/${data.id}/update`,
                data,
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
            ...
            router.visit("/supplier-categories", {
                data: {
                    message: "Berhasil mengubah data katagori supplier..!!",
                },
            });
        } catch (err) {
            if (!err?.response) {
        ...
        <>
            <div>
                <form onSubmit={handleSubmit}>
                    <HeaderEdit
                        titleEdit="Data Katagori Supplier"
                        backUrl="/supplier-categories"
